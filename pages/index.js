        ...
        <fieldset style={{ border: '1px solid #ddd', padding: 20, marginBottom: 20 }}>
          ...
          <div style={{ marginBottom: 20, padding: 15, backgroundColor: '#f8f9fa', borderRadius: 6 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <span>Il/La sottoscritto/a, ricevuta l'informativa ai sensi dell'art. 13 del D.lgs. 196/2003, dà il consenso al trattamento dei propri dati personali nella misura necessaria al raggiungimento degli scopi statutari e con le modalità indicate nell'informativa medesima.</span><br/>
              <input 
                type="text" 
                name="sottoscritto" 
